...
@Injectable()
export class AppwriteAvatarsService {
...
* When one dimension is specified and the other is 0, the image is scaled
  ...
  getBrowser(code: string, width?: number, height?: number, quality?: number): URL {
    const urlPath = '/avatars/browsers/{code}'.replace('{code}', code);
    const payload: Payload = {  width, height, quality,  };
...
* 
  ...
  getCreditCard(code: string, width?: number, height?: number, quality?: number): URL {
    const urlPath = '/avatars/credit-cards/{code}'.replace('{code}', code);
    const payload: Payload = {  width, height, quality,  };
...
* 
  ...
  getFlag(code: string, width?: number, height?: number, quality?: number): URL {
    const urlPath = '/avatars/flags/{code}'.replace('{code}', code);
    const payload: Payload = {  width, height, quality,  };
...
* 
  ...
  getImage(url: string, width?: number, height?: number): URL {
    const urlPath = '/avatars/image';
    const payload: Payload = {  url, width, height,  };
...
* 
  ...
  getInitials(name?: string, width?: number, height?: number, background?: string): URL {
    const urlPath = '/avatars/initials';
    const payload: Payload = {  name, width, height, background,  };
...
* 
  ...
  getQR(text: string, size?: number, margin?: number, download?: boolean): URL {
    const urlPath = '/avatars/qr';
    const payload: Payload = {  text, size, margin, download,  };
